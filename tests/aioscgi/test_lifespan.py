...
def test_lifespan_startup_successful() -> None:
    ...
    async def impl() -> None:
        ...
        # The lifespan manager should keep running after a successful start, so cancel
        # it.
        uut_future.cancel()
        await uut_future
...
def test_lifespan_startup_failed() -> None:
...
def test_lifespan_shutdown_successful() -> None:
...
def test_lifespan_shutdown_failed() -> None:
...
def test_lifespan_not_supported() -> None:
